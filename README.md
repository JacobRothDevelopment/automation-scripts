...
| winfind.ps1    | Recursively search for a filename in current directory                         | 2.0.0          |
| wingrep.ps1    | Recursively search for text in any file in current directory                   | 2.0.0          |
